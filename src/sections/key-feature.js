...
export default function KeyFeature() {
  return (
    <section sx={{ variant: 'section.keyFeature' }} id="feature">
      <Container>
        <SectionHeader slogan="About Us" title="Welcome to Betagas" />
        <SectionHeader
          title2="Betagas is a leading company of storage and distribution of cleaner,
          affordable and environmentally friendly LPG since 2020."
        />
